...
inline void bwimage_setPixelValue(bwimage_t *i, int x, int y, uint8_t cl) __attribute__((always_inline));

inline ycbcr_color_t convertToYCbCrColor(rgb_color_t cl) __attribute__((always_inline));
